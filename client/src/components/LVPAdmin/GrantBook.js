...
class GrantBook extends Component {
  constructor (props) {
    super(props)
        ...
        <div>
          <div className="col-sm-12">
            <div className="row col-md-12 m-auto">
              <h2>Grant access of Entire Book</h2>
            </div>
            <h6> You can remove access again, Do you wish to continue?</h6>
...
export default connect(mapStateToProps,{ grantFolder})(GrantBook)
